---
title: "Standard Gaussian Processes"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Standard Gaussian Processes}
...
GPCERF will first convert the covariate values into a single composite score (GPS) and then use it to fit the Gaussian processes. We use the GPS estimation function in CasaulGPS (see [here](https://nsaph-software.github.io/CausalGPS/articles/Estimating-GPS.html)) to get the GPS model that maps covariates into GPS.
